...
import numpy as np
import time
from data import cfg_mnet, cfg_re50,cfg_shuffle
...
parser.add_argument('-m', '--trained_model', default='/home/lyp/Downloads/Resnet50_epoch_210.pth',
...
if __name__ == '__main__':
    ...
    threed_5_points = np.load(
        "/home/lyp/paper_experiments/img2pose-main/pose_references/reference_3d_5_points_trans.npy")
    ...
    #for iii in range(len(lines1)):
        ...
        # image_path = "/home/lyp/paper_experiments/plot_paper_curve/suppm/img/widerface/results/44_Aerobics_Aerobics_44_597.jpg"
